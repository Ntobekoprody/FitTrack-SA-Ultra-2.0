...
fun stringsFor(language: UserSettings.Language): AppStrings = when (language) {
    UserSettings.Language.ENGLISH -> AppStrings(
        ...
        register = "Register",
        registerSubtitle = "Set up your profile to get started",
        registerCta = "Save & Continue",
    ...
    UserSettings.Language.ISIZULU -> AppStrings(
        ...
        register = "Bhalisa",
        registerSubtitle = "Hlela iphrofayela yakho ukuze uqale",
        registerCta = "Gcina uqhubeke",
        registerBackToLogin = "Buyela ekungeneni",
        ...
        profileEmailLabel = "Ikheli le-imeyili",
        profileEmailPlaceholder = "john@example.com",
